...
@section('content')
    ...
    @endphp
    <div class="page-heading"><div><h1>Create Order</h1><p>Create an order directly from the admin panel.</p></div><a href="{{ $backUrl }}" style="color:#d95800;text-decoration:none"><i class="fa-solid fa-arrow-left"></i> Back to List</a></div>
