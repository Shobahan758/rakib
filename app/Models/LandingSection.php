    ...
    private static function productDefaults(): array
    {
        $defaults  = [
            ...
            'seo'           => [
                ...
                'meta_author' => 'Solution Mart', 'canonical_url' => 'https://furniturepolish.solutionmartbd.com/', 'robots' => 'index, follow',
            ...
            'hero'          => [
                ...
                'regular_price_label' => 'আগের মূল্য',
                'offer_price_label'   => 'বর্তমান অফার মূল্য',
                'savings_label'       => 'সেভ',
